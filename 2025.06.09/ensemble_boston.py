...
axs[0].set(xlabel='Фактические значения', ylabel='Предсказанные занчения', title=f'Stacking\nr2 = {r2_stacking}')

axs[1].scatter(y_test_1, y_pred_bagging)
axs[1].axline((y_test_1.mean(), y_pred_bagging.mean()), slope=slope_bagging, c='#f54242')
axs[1].set(xlabel='Фактические значения', ylabel='Предсказанные занчения', title=f'Bagging\nr2 = {r2_bagging}')

axs[2].scatter(y_test_1, y_pred_rforest)
axs[2].axline((y_test_1.mean(), y_pred_rforest.mean()), slope=slope_rforest, c='#f54242')
axs[2].set(xlabel='Фактические значения', ylabel='Предсказанные занчения', title=f'RandomForest\nr2 = {r2_rforest}')
